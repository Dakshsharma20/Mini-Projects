...
function RockPaper() {
   ...
   return (
     <div className='overflow-x-hidden p-4 font-["Poppins"] bg-[#1A2949]  h-[100vh]'>
       ...
       <div className="flex justify-between gap-1 text-white max-w-5xl mx-auto mt-10 items-center flex-wrap text-sm sm:text-xl">
         <p className="bg-[#1d3c83] py-1 px-2 sm:px-4 rounded-[3px]">
           My Score - {userScore}
         </p>
       ...
       <p
         className={
           result
             ? "bg-[#1d3c83] py-1 px-4 rounded-[3px] text-white mt-4 w-fit mx-auto sm:text-xl"
             : "hidden"
         }
       >
         {result}
       ...
       {computerScore > 0 || userScore > 0 ? (
         <button
           className="bg-[#1d3c83] py-1 px-4 rounded-[3px] text-white mx-auto mt-4 hover:bg-[#1a4f46] sm:text-lg block outline-none"
           onClick={reset}
         >
           Reset
         </button>
       ...
       <div className="flex justify-center  gap-12 text-white max-w-5xl mx-auto  mt-10 sm:gap-28">
         <div className=" flex flex-col items-center gap-4 border-2 border-transparent rounded-md bg-[#1d3c83] p-4 w-44">
       ...
       <div className="flex flex-col justify-center items-center mt-14 gap-4">
         <h2 className="text-white sm:text-lg bg-[#1d3c83] py-1 px-4 rounded-[3px]">
           Lock Your Choice
         </h2>
...
// function RockPapperScisor() {
//     const [userChoice, setUserChoice] = useState("")
//     const [computerChoice, setComputerChoice] = useState("")
//     const [winner, setWinner] = useState("")
//     const optionList = ['Rock', 'Paper', 'Scisor']
//     const startGame = (user)=>{
//         setUserChoice(user);

//         const randomNum = Math.floor(Math.random()*3)
//         const localCompChoice = optionList[randomNum]
//         setComputerChoice(optionList[randomNum])
...
//                 <div onClick={()=> startGame("Papper")}>Papper</div>
...
// export default RockPapperScisor